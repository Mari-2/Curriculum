...
<body>
    <div class="col-lg-5 mx-auto p-3 py-md-5">
        <main>
            ...
            ?>
            <br>
            <a class="btn btn-primary" href="experiencialista.php" >Ver curriculum</a>
            <a class="btn btn-success" href="datospersonas.html">Editar registro</a>
            <a class="btn btn-primary" href="" >Borrar registro</a>
            <a class="btn btn-primary" href="Curriculum.php" >Curriculum</a>
